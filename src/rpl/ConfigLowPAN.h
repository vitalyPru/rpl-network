#ifndef __CONFIGURE_LOWPAN_H

    #define __CONFIGURE_LOWPAN_H
    ...
    #include "ConfigApp.h"
		...
		#define		TRICKLE_MAX_FACTOR			20
		#define		TRICKLE_MIN_INTERVAL		(ONE_SECOND/10)
		#define		TRICKLE_REDUNDANCY_CONST	10

		#define		DIS_TIMER_TIME 			    (ONE_SECOND)
		#define     DIS_TIMER_REPEAT			5

//		#define     OF_SELECTED_METRIC			Rssi
